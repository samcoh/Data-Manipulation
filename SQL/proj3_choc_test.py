...
class TestCompanySearch(unittest.TestCase):
    ...
    def test_company_search(self):
        ...
        #print(float(str(results[0][2].split('%')[0]))*.010)
        self.assertEqual(results[0][0], 'Videri')
        self.assertGreater(float(str(results[0][2].split('%')[0]))*.010, 0.79)
        # I talked with a GSI and we changed the test case because there is nothing wrong with my original code
